      ...
      <div className="mx-auto max-w-3xl rounded-2xl bg-white">
        ...
        <div className="p-10">
          ...
          <section>
            ...
            <textarea className="mt-4 h-48 bg-orange-100 w-full rounded-3xl border p-5"placeholder={'Bijvoorbeeld: "We willen onze bestaande stal vervangen door zes paardenboxen met een ruime wasplaats."'}/>
          </section>
          ...
          <section className="mt-8">
            ...
            <label className="mt-4 flex h-40 cursor-pointer bg-orange-100  flex-col items-center justify-center rounded-2xl border-2">
